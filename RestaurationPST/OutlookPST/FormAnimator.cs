...
{
    /// <summary> Animates a form when it is shown, hidden or closed.
    /// </summary>
    /// <remarks> MDI child forms do not support the Blend method and only support other methods while being displayed for the first time and when closing.
    /// </remarks>
